        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+1416-420-4167'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'mr.vishnu1995@gmail.com'}  title={'Email'}/>
                    <ContactItem icon={location} text1={'3050 Ellesmere Road'} text2={'Toronto'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
